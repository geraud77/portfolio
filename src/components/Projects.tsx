...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "An intelligent chat application powered by OpenAI GPT-3. Features include conversation history, multiple AI personalities, and natural language processing capabilities.",
      image: "/api/placeholder/600/400",
      category: "ai",
      technologies: ["Python", "OpenAI API", "Flask", "React", "PostgreSQL"],
      liveUrl: "https://project3.com",
      githubUrl: "https://github.com/geraudvtalah/ai-chat",
      features: [
        "AI Chat",
    ...
    },
    {
      ...
      liveUrl: "https://geraudvtalah.com",
      githubUrl: "https://github.com/geraudvtalah/portfolio",
      features: [
        "Responsive Design",
        "Dark Mode",
        "Smooth Animations",
    ...
    },
    {
      ...
      description:
        "A comprehensive weather application with location-based forecasts, interactive maps, and detailed weather analytics. Integrates with multiple weather APIs.",
      image: "/api/placeholder/600/400",
      category: "fullstack",
      technologies: [
        "React",
      ...
      githubUrl: "https://github.com/geraudvtalah/weather-dashboard",
      features: [
